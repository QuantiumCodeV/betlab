...
@section('panel')
    <div class="row gy-4">
        <div class="col-xxl-3 col-sm-6">
            <x-widget style="6" link="{{ route('admin.users.all') }}" icon="las la-users" title="Total Bettors" value="{{ $widget['total_users'] }}" bg="primary" />
        </div>
        <div class="col-xxl-3 col-sm-6">
            <x-widget style="6" link="{{ route('admin.users.active') }}" icon="las la-user-check" title="Active Bettors" value="{{ $widget['verified_users'] }}" bg="success" />
        </div>
        <div class="col-xxl-3 col-sm-6">
            <x-widget style="6" link="{{ route('admin.users.email.unverified') }}" icon="lar la-envelope" title="Email Unverified Bettors" value="{{ $widget['email_unverified_users'] }}" bg="danger" />
        </div>
        <div class="col-xxl-3 col-sm-6">
            <x-widget style="6" link="{{ route('admin.users.mobile.unverified') }}" icon="las la-comment-slash" title="Mobile Unverified Bettors" value="{{ $widget['mobile_unverified_users'] }}" bg="warning" />
        </div>
    </div>
    ...
    <div class="row gy-4 mt-2">
        <div class="col-xxl-3 col-sm-6">
            <x-widget style="6" link="{{ route('admin.bet.pending') }}" title="Pending Bet" icon="las la-pause-circle" value="{{ $widget['pendingBet'] }}" bg="warning" outline="true" />
        </div>
        <div class="col-xxl-3 col-sm-6">
            <x-widget style="6" link="{{ route('admin.deposit.pending') }}" title="Pending Deposits" icon="las la-wallet" value="{{ $deposit['total_deposit_pending'] }}" bg="amber" outline="true" />
        </div>
        <div class="col-xxl-3 col-sm-6">
            <x-widget style="6" link="{{ route('admin.withdraw.data.pending') }}" title="Pending Withdrawals" icon="las la-credit-card" value="{{ $withdrawals['total_withdraw_pending'] }}" bg="orange" outline="true" />
        </div>
        <div class="col-xxl-3 col-sm-6">
            <x-widget style="6" link="{{ route('admin.ticket.pending') }}" title="Pending Tickets" icon="la la-ticket" value="{{ $withdrawals['total_withdraw_pending'] }}" bg="primary" outline="true" />
        </div>
    </div>
