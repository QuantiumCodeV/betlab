    ...
    <div class="modal fade" id="updateCron" tabindex="-1" role="dialog" a aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form class="form-horizontal disableSubmission resetForm" method="post" action="{{ route('admin.cron.update') }}">
                    @csrf
    ...
    <script>
        (function($) {
            ...
            $('.updateCron').on('click', function(e) {
                ...
                modal.find("[name=cron_schedule_id]").val(cron_schedule_id).change();
                modal.modal('show');
            });
